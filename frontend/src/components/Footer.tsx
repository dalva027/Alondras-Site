      ...
      <div className="container">
        <div className="footer__grid">
          <div className="footer__brand">
            ...
            <div className="footer__social">
              ...
              <a href="#" className="footer__social-link" aria-label="Google Maps">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0C7.802 0 4 3.403 4 7.602 4 11.8 7.469 16.812 12 24c4.531-7.188 8-12.2 8-16.398C20 3.403 16.198 0 12 0zm0 11a3 3 0 110-6 3 3 0 010 6z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className="footer__links">
            ...
            <ul>
              <li><Link to="/" onClick={(e) => { e.preventDefault(); window.scrollTo(0, 0); }}>Home</Link></li>
        ...
        <div className="footer__bottom">
          <p>&copy; {currentYear} Alondra's Mexican Restaurant. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
